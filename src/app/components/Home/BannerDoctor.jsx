...
const BannerDoctor = ({ isMobile }) => {
    return (
        <section className="text-brand bg-black shadow-[0_29px_34px_10px_rgba(0,0,0,0.3)] flex z-1 flex-col md:flex-row items-center relative w-100%  mx-auto lg:gap-[40px]">
